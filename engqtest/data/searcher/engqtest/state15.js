var text15 = "WebGL: This state lets you play with coupled pendulums.";
...
function init15() {
	...
	makeabut("less damp2",null,lessdamp2);
	makeabut("more damp2",null,moredamp2);
	makeabut("reset damp2",null,resetdamp2,null,true);
	resetdamp2();
