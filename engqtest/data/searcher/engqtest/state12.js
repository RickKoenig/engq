...
var text12 = "WebGL: This state tests surface patches including strands and braids. Drag the mouse left and right to see an effect.";
...
function proc12() {
	...
	var lps = phasestrand;
	if (input.mbut[0])
		phasestrand = 2 * Math.PI * input.mx / gl.viewportWidth;
/*	phasestrand += .04;
