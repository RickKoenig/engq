...
//     	gl.drawElements(gl.TRIANGLES,this.nface*3,gl.UNSIGNED_SHORT,0);
//     	gl.drawElements(gl.TRIANGLES,this.nface*3,gl.UNSIGNED_INT,0);
    } else {
	...
	//if (!this.hasalpha) { // turn it back on
		//if (true)
		if (shadowmap.inshadowmapbuild)
