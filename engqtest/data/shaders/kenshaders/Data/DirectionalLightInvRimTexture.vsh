...
/*
const char DirectionalLightInvRimTextureVertex[] =
...
// 9"    g_Normal = WorldViewInverseTranspose * Normal;\n"
	"    g_ObjPos = (WorldView * Position).xyz;\n"
	"}\n"
;

const char DirectionalLightInvRimTextureFrag[] =
...
// 14
			 (1.0 - finalRimFactor) * g_Color * texture2D(tex1, g_UV);\n"
