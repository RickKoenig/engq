...
// 13
	...
	mad		tcolor.xyz,tmp2.xyz,C2T2,tcolor.xyz
//  mov		tcolor.w,ONEV // alpha here
// 14
	mul		tcolor.xyz,tcolor,ScaleFactor
    mov		tcolor.w,ONEV // or alpha here
	mul		oColor,tcolor,aColor
    end	// output to all output registers before calling 'end'
endmain:
// frag shader should multiply oColor with tex0(UV0) and with tex1(UV1)
/*
const char FunstonSphericalHarmonicsLMVertex[] =
	"#version 110\n"
...
const char FunstonSphericalHarmonicsLMFrag[] =
	"#version 110\n"
