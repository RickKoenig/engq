const char TerrainLightMap2CVertex[] =
...
const char TerrainLightMap2CFrag[] =
...
//	"uniform vec4 fogTopColor;\n"
	...
	"void main() {\n"
	"    vec4 col = (g_Color.r * texture2D(tex1, g_UV0) + g_Color.g * texture2D(tex2, g_UV0)) * texture2D(tex3, g_UV1);\n"
