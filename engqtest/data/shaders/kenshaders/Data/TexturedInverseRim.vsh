...
// 10
	...
	mul		tcolor.xyz,aColor,finalRimFactor
	mov		tcolor.w,ONEV.w
...
/*
const char TexturedInverseRimVertex[] = 
	"#version 110\n"
...
const char TexturedInverseRimFrag[] =
	"#version 110\n"
...
// 10
			(1.0 - finalRimFactor) * texture2D(tex1, g_UV) * g_Color;\n"
	"}\n"
;
*/