...
//  mov		tcolor.w,ONEV
// 14
	mul		tcolor.xyz,tcolor,ScaleFactor // alpha ?
    mov		tcolor.w,ONEV
...
/*
const char FunstonSHNegInvRimVertex[] =
	"#version 110\n"
...
const char FunstonSHNegInvRimFrag[] =
	"#version 110\n"
...
// 17
	"    float viewDot = dot(viewVec, normalize(g_Normal.xyz));\n"
// 18
