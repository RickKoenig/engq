...
// nn hmm, what color to output... ? g_Color 'funston' modulates tex0(UV0)*tex1(UV1) + (finalRimFactor * RimColor)(rim, no texture)
...
// 19
	"    gl_FragColor = vec4((finalRimFactor * RimColor), 0.0) + 
			...
			g_Color * texture2D(tex1, vec2(g_UV.x, 1.0 - g_UV.y)) * texture2D(tex2, vec2(g_UV1.x, 1.0 - g_UV1.y));\n"
	"}\n"
;
*/