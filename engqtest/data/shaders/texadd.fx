// used for fonts, fontq and sprites
// Main fx
// just like tex.fx but adds instead of mul, alpha still muls
...
// modulate texture with material color
    ...
    Output.RGBColor.rgb = g_material_color.rgb;
    Output.RGBColor.a *= g_material_color.a;
//  Output.RGBColor.r = 1;
    return Output;
}
