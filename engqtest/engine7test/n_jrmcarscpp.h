...
//TREE *loadnewjrms(const char *carnamearg,const char *textnamearg);
tree2 *loadnewjrms2(const char *carname,int paint,int decal);
...
extern pointf3 jrmcarrot;
extern pointf3 jrmcartrans;
