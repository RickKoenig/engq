...
void example3(int argc, char *argv[])
{
  ...
  /*encode and save*/
  LodePNG_Encoder_encode(&encoder, &buffer, &buffersize, image, w, h);
...
/* This doesn't improve the original PNG file at all, it just tests both the  */
/* decoding and encoding of this library                                      */
/* ////////////////////////////////////////////////////////////////////////// */
...
void example8(int argc, char *argv[])
{
  ...
  LodePNG_Encoder_encode(&encoder, &buffer, &buffersize, image, decoder.infoPng.width, decoder.infoPng.height);
  if(encoder.error)
  {
