...
tree2* buildprismuvs(const pointf3& size,C8* texname,C8* matname,const uv& uv0,const uv& vu1);
...
extern pointf3 prismverts[nprismverts];
extern pointf3 prismnorms[nprismverts];
extern uv prismuvs[nprismverts];
extern face prismfaces[nprismfaces];
